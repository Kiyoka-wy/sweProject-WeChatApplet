...
Page({
  ...
  onShow: function () {
    ...
    that.data.address = []
    that.data.addressId = []
    for (var i = 0; i < app.globalData.place.length; i++) {
      that.setData({
        address: that.data.address.concat(app.globalData.place[i].address + app.globalData.place[i].detailAddress),
        addressId: that.data.addressId.concat(app.globalData.place[i].addressID),
      })
    }
          //that.setData({
  ...
  formSubmit(e) {
    ...
    if (e.detail.value.fromLocation == null) {
      wx.showToast(
        {
          title: "请填写完整1",
          duration: 1000
    ...
    else if (e.detail.value.toLocation == null) {
      wx.showToast(
        {
          title: "请填写完整2",
          duration: 1000
    ...
    else if (e.detail.value.title == null) {
      wx.showToast(
        {
          title: "请填写完整3",
          duration: 1000
    ...
    else if (e.detail.value.content == null) {
      wx.showToast(
        {
          title: "请填写完整4",
          duration: 1000
    ...
    else if (e.detail.value.amount == null) {
      wx.showToast(
        {
          title: "请填写完整6",
          duration: 1000
